...
class FrontendContentController extends Controller
{
    ...
    public function index(){
        ...
        return view('superadmin.frontendContent.index', compact('data'));
    }
    ...
    public function create(){
    	$data = Page::get();
    	return view('superadmin.frontendContent.create', compact('data'));
    }
    ...
    public function store(Request $request){
        ...
        try{
        	...
        	return redirect('/superadmin/frontend-contents/')->withSuccess('Page has been created successfully.');
    	} catch(\Exception $e) {
    ...
    public function edit($encryptId){
        ...
        try{
        	$data = Page::get();
            return view('superadmin.frontendContent.edit', compact('data','page'));
        } catch(\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function update(Request $request, $encryptId)
    {
        ...
        try{
            ...
            return redirect('superadmin/frontend-contents/')->withSuccess('Page has been updated successfully.');
        } catch(\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
