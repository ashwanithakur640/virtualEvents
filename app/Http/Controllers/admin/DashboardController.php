...
class DashboardController extends Controller
{
    ...
    public function index(){
    	...
    	return view('admin.dashboard', compact('vendors', 'customers', 'events' , 'todayEvents' , 'futureEvents' , 'weekEvents' , 'todayEventsDetails', 'pastEvents' , 'holdEvents' , 'rescheduledEvents'));
    }
    ...
    public function updatePassword(Request $request){
        ...
        try{
            ...
            return redirect('admin/login')->withSuccess('Password has been changed successfully');
        } catch(\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
