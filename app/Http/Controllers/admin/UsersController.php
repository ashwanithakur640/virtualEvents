...
class UsersController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                        ...
                        ->addColumn('action', function ($modal) {  
                            ...
                            $action = '<a href="'.url("admin/vendors/show-vendor/".Helper::encrypt($modal->id)).'" data-toggle="tooltip" title="View"><i class="fa fa-eye"></i></a>&nbsp
                                <a href="'.url('admin/vendors/edit-vendor/'.Helper::encrypt($modal->id)).'" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>&nbsp
                                <a class="deleteRecord" data-toggle="tooltip" title="Delete" style="color: #4e73df;"><i class="fa fa-trash"></i></a>
                                <form action="'.url('admin/vendors/delete-vendor/'.Helper::encrypt($modal->id)).'" method="POST" style="display: none;">
    ...
    public function store(Request $request){
        ...
        try{
            ...
            return redirect('/admin/vendors')->withSuccess('Vendor has been created successfully.');
        } catch(\Exception $e) {
    ...
    public function verifyAccount($securityToken){
        ...
        if($verifyTokenData){
            ...
            return redirect('/admin/vendors')->withSuccess('Account has been verify successfully.');
        }else{
            return redirect('/admin/vendors')->withError('Link has been expired.');
        }
    }
    ...
    public function show($encryptId)
    {
        ...
        try{
            return view('admin.vendors.view', compact('data'));
        } catch(\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function update(Request $request, $encryptId)
    {
        ...
        try{
            ...
            return redirect('admin/vendors/')->withSuccess('Vendor has been update successfully');
        } catch(\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function customerIndex(Request $request){
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                        ->addIndexColumn()
                        ->addColumn('action', function ($modal) {                
                             $action = '<a href="'.url("admin/customers/show-customer/".Helper::encrypt($modal->id)).'" data-toggle="tooltip" title="View"><i class="fa fa-eye"></i></a>&nbsp
                                <a href="'.url('admin/customers/edit-customer/'.Helper::encrypt($modal->id)).'" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>&nbsp
                                <a class="deleteRecord" data-toggle="tooltip" title="Delete" style="color: #4e73df;"><i class="fa fa-trash"></i></a>
                                <form action="'.url('admin/customers/delete-customer/'.Helper::encrypt($modal->id)).'" method="POST" style="display: none;">
                                    <input type="hidden" name="_token" value="'. csrf_token() .'">
                                    <input type="hidden" name="_method" value="DELETE">
                                </form>';
                             return $action;
    ...
    public function customerShow($encryptId)
    {
        ...
        try{
            ...
            return view('admin.customers.view', compact('data' , 'count'));
        } catch(\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function customerUpdate(Request $request, $encryptId)
    {
        ...
        try{
            ...
            $reqData['role_id'] = '2';
            User::where('id', $id)->update($reqData);
            return redirect('admin/customers/')->withSuccess('Customer has been update successfully');
        } catch(\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
