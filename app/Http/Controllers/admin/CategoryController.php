...
class CategoryController extends Controller
{
    ...
    public function store(Request $request){
        ...
        try{
        	...
        	return redirect('/admin/categories/')->withSuccess('Category has been added successfully.');
    	} catch(\Exception $e) {
    ...
    public function update(Request $request, $encryptId){
        ...
        try{
            ...
            return redirect('admin/categories/')->withSuccess('Category has been update successfully');
        } catch(\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
