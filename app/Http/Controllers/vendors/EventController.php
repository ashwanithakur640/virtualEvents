       ...
       // try{
            ...
            if(!empty($request->speakers)){
                ...
                // {
                    ...
                    $eid = Helper::encrypt($event->id);
                    $url=url('exhibit-hall/event-detail/'.$eid);
                    ...
                    $mailData = [    
                        ...
                        'event_url'=>'<a href="'.$url.'">Click Here To Join</a>',
                ...
                //https://virtualevent.yapits.com/exhibit-hall/event-detail/
        ...
        try{
            ...
            if(!empty($request->speakers)){
                ...
                foreach($request->speakers as $speakers){
                    ...
                    $dm = EveParticipant::where('event_id',$id)->where('user_id', $speakers)->first();
