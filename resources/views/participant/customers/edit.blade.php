            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form id="editCustomersForm" action="{{ asset($Prefix .'/update-customer/'.Helper::encrypt($data->id)) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-actions border-none">
                                        ...
                                        <a class="btn btn-warning mr-1" href="{{ asset($Prefix .'/end-user/') }}">Cancel</a>
                                    </div>
                                    @section('script')
