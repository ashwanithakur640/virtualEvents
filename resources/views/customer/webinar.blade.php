...
<?php
    ...
    ?>
     ...
     <li>
        <a class="active" style="display: none;" id="mute-audio" data-userid="{{$user->id}}" href="#"  data-toggle="tooltip" title="Mute Mic"><i class="fa fa-microphone" aria-hidden="true"></i></a>
        <a class="" id="unmute-audio" href="#"   data-toggle="tooltip" title="Unmute Mic"><i class="fa fa-microphone-slash" aria-hidden="true"></i></a>
    </li>
