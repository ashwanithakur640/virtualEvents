        ...
        <div class="container">
            <ul class="nav page-navigation">
                ...
                <li class="nav-item {{ \Request::segment(2) == 'events' ? 'active' : ''}}">
                    ...
                    <div class="submenu">
                        <ul class="submenu-item">
                            <li class="nav-item {{ \Request::segment(3) == 'create-events' ? 'active' : ''}}">
                                <!-- <a class="nav-link" href="{{ asset('vendor/events/create-event') }}">Add</a> -->
                                <a class="nav-link" href="{{ asset($Prefix . '/participants') }}">Participants</a>
                            </li>
                            <li class="nav-item {{ \Request::segment(2) == 'events' && \Request::segment(3) == '' ? 'active' : ''}}">
                                <a class="nav-link" href="{{ asset($Prefix . '/employee') }}">Employee</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item {{ \Request::segment(2) == 'events' ? 'active' : ''}}">
                    ...
                    <div class="submenu">
                        <ul class="submenu-item">
                            <li class="nav-item {{ \Request::segment(3) == 'create-events' ? 'active' : ''}}">
                                <!-- <a class="nav-link" href="{{ asset('vendor/events/create-event') }}">Add</a> -->
                                <a class="nav-link" href="{{ asset($Prefix . '/create-events') }}">Add</a>
                            </li>
                            <li class="nav-item {{ \Request::segment(2) == 'events' && \Request::segment(3) == '' ? 'active' : ''}}">
                                <a class="nav-link" href="{{ asset($Prefix . '/events') }}">List</a>
                            </li>
                        </ul>
                    </div>
                </li>
                    ...
                    <div class="submenu">
                        <ul class="submenu-item">
                            <li class="nav-item {{ \Request::segment(3) == 'create-session' ? 'active' : ''}}">
                                ...
                                <a class="nav-link" href="{{ asset($Prefix . '/create-session') }}">Add</a>
                            </li>
                            <li class="nav-item {{ \Request::segment(2) == 'session' && \Request::segment(3) == '' ? 'active' : ''}}">
                                <a class="nav-link" href="{{ asset($Prefix . '/session') }}">List</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item {{ \Request::segment(2) == 'events' ? 'active' : ''}}">
                    ...
                    <div class="submenu">
                        <ul class="submenu-item">
                            <li class="nav-item {{ \Request::segment(3) == 'customers-enrolled' ? 'active' : ''}}">
                                <a class="nav-link" href="{{ asset($Prefix . '/customer-enrolled') }}">Customers Enrolled in my events</a>
                                <a class="nav-link" href="{{ asset($Prefix . '/session-listings') }}">Chat Reports</a>
                                <a class="nav-link" href="{{ asset($Prefix . '/feedback-listings') }}">Feedback Reports</a>
 <a class="nav-link" href="{{ asset($Prefix . '/attendee-reports') }}">Attendees Report </a>
               ...
               <!--  <li class="nav-item">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="{{ asset($Prefix . '/video-content') }}">
