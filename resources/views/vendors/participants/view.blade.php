...
<div class="ml-3">
<h2>Upload Documents for events : </h2>
<br>
@foreach($events as $parti)

    <form id="categoryForm" action="{{ asset($Prefix . '/add-participant-data') }}" method="post" enctype="multipart/form-data">
  @csrf
...
<?php } ?>
 ...
 <div class="row">
                                    <div class="form-group col-md-12">
                                        <div class="border_text">
            <label>Upload Doc<span class="asterisk">*</span></label>
