            ...
            <div class="box-body">
                <div class="row">  
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form id="editAdminProfileForm" action="{{ asset($Prefix.'/update-profile') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-7">
                                            ...
                                            <div class="form-actions border-none">
                                                ...
                                                <a class="btn btn-warning mr-1" href="{{ asset($Prefix.'/dashboard') }}">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
