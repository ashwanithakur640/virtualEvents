            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="{{ asset('superadmin/faq-report/update-answer/'.Helper::encrypt($data->id)) }}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-actions border-none">
                                        ...
                                        <a class="btn btn-warning mr-1" href="{{ asset('superadmin/faq-report/') }}">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
