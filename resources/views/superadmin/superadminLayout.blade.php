...
<html lang="en">
	...
	<body id="page-top">
				      	...
				      	<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item dropdown no-arrow">
								...
								<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
									<a class="dropdown-item" href="{{ url('/superadmin/edit-profile') }}">
										<i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
										Profile
									</a>
									<a class="dropdown-item" href="{{ url('/superadmin/change-password') }}">
        ...
        <!-- Start custom js -->
        <script src="{{ asset('assets/js/superadmin/admin.js') }}"></script>
        <!-- End custom js -->
