...
@section('content')
    <section class="content- mb-2 d-flex align-items-center justify-content-between">
        ...
        <h1 class="pull-right mb-0">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{{ asset('superadmin/frontend-contents/create-frontend-content') }}">Add Content</a>
        </h1>
    </section>
    <div class="content">
                        ...
                        <tbody>
                           @if($data->count() > 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='btn-group'>
                                            <a href="{{ asset('superadmin/frontend-contents/edit-frontend-content/'.Helper::encrypt($value->id)) }}" class='btn btn-primary btn-xs' data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
