...
@section('content')
	<section class="content- mb-2 d-flex align-items-center justify-content-between">
        <h1 class=" mb-0pull-left">Weekly Events</h1>
        <h1 class="pull-right mb-0">
       <!--     <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{{ asset('super/events/create-event') }}">Add Event</a> -->
        </h1>
    </section>
    <div class="content">
...
$(document).ready(function(){
    ...
    var table = $('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax:{
            url: "{{ asset('superadmin/events/weekly-events') }}",
        },
        columns:[
            {
                data: 'id',
