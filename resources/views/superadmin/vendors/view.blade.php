                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-5 left_side_profile">
                                        <div class="form-group {{ $errors->has('image') ? 'error' : ''}}">
                                            ...
                                            <h3> {{ $data->salutation }} {{ $data->first_name }} {{ $data->middle_name }} {{ $data->last_name }}</h3>
                                            <h5>{{ $data->email }}</h5>
                            ...
                            @if($data->role_id == 1)         
       <a href="{{ route('state', $data->id) }}" class="btn btn-primary ml-3 mb-3 custom">
...
@endif
                         ...
                         @if($data->role_id == 1)         
       <a href="{{ route('pay-state', $data->id) }}" class="btn btn-primary ml-3 mb-3 custom">

 @if($data->can_pay_offline == User::PAY_OFFLINE)
            Pay Online 
            @else
                @if( $data->can_pay_offline == User::PAY_ONLINE )
            Pay Offline
             @endif
        @endif
        </a>    
