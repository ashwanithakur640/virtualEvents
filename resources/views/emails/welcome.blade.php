  ...
  <body  margintop="0" marginbottom="0" marginright="0" marginleft="left" marginwidth="0" marginheight="0" offset="0">
    <table width="900" align="center" cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>
          <img src="{{ asset('assets/images/email/participant-bg.png' ) }}" alt="participant-bg" border="0" width="100%">
          </th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          <td style="font-size:26px;color:#444444;text-align:center;font-weight:300">{{ $data['message'] }}</td>
        </tr>
        <tr>
          <td height="40"></td>
        </tr>
        ...
        <tr>
          <td style="font-size:26px;color:#444444;text-align:center;font-weight:300"><strong>Password:</strong> {{ $data['password'] }}</td>
        </tr>
        <tr>
          <td height="40"></td>
        </tr>
        <tr>
          <td align="center"><a href="{{ $data['url'] }}"><img src="{{ asset('assets/images/email/login-btn.png' ) }} " alt="login-btn" border="0"></a></td>
        </tr>
        <tr>
          <td height="40"></td>
        </tr>
