            ...
            <div class="box-body">
                <div class="row">  
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form id="editAdminProfileForm" action="{{ asset('employee/update-profile') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <select name="salutation" id="salutation" class="form-control valid" aria-invalid="false"> 
                                            ...
                                            <div class="form-actions border-none">
                                                ...
                                                <a class="btn btn-warning mr-1" href="{{ asset('employee/edit-profile') }}">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
