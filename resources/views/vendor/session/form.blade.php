 ...
 <div class="row">
                        <div class="col-md-12 col-sm-12">
                          <div class="vertual-inputs">
                           <label>{{__('Presenters')}} <a href="javascript:void(0)" data-toggle="tooltip" title="Enter email to select presenters who will present the conference"><i class="fa fa-question-circle"></i></a></label>
                         <select class="multiple-select-speaker-conference" name="speakers[]" multiple="multiple">
                                @forelse($user as $speaker)
