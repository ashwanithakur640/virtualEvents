var appId = "ebad90cb92fa4036b9c5dc8aad1bc433";
var jonee;
var organizer_id;
var translators_id;
var time_left;
...
function addView(jonee, show) {
  if (!$("#remote_video_panel_" + jonee.id)[0]) {
    ...
    if (remote_controls_access == 1) {
      div = `
<li id="remote_video_panel_` + jonee.id + `" class="` + class_div + `">
   <div class="col-sm-12">
      <div class="testimonial-outr">
         <div class="testimonial-content1" id="remote_video_` + jonee.id + `">
            ...
            <div class="slider-bottom">
               <h4>  ` + jonee.first_name + ` </h4>
            </div>
         </div>
         <div class="testimonial-lower-outr">
            <a class="pinUser" href="javascript:pinUser(` + jonee.id + `)"><i class="fa fa-thumb-tack" aria-hidden="true"></i></a>
         </div>
      </div>
   </div>
</li>
   ...
   // console.log('here ======= 1');
    ...
    if (remote_controls_access == 1 && user_is_presenter != 1) {
      ...
      if (!jonee.presenter) {
        ...
        var appenTo = `<li id="participant_` + jonee.id + `">
                      <div class="participant-outer"><div class="participant-right-div">
                          <h1>` + jonee.first_name + `</h1>
                        `;
        if (jonee.id != user.id) {
          let color = '';
          let icon = ''
          ...
          appenTo += ` <a class="presenter" id="make_presenter_` + jonee.id + `" href="javascript:makepresenter(` + jonee.id + `,'true')"><i class="fa fa-television admin-icon" aria-hidden="true"></i></a><a onClick="un_raise_admin(` + jonee.id + `)" data-user="` + jonee.id + `" id="raise_btn_mute_` + jonee.id + `" style="display:none" title="Lower Hand"><img src="` + icon + `" class="hands-raised"></a><a style="display:none;" id="pin_user_raise_` + jonee.id + `" href="javascript:pinUser(` + jonee.id + `)"><i class="fa fa-thumb-tack" aria-hidden="true" style="color:#72b772"></i></a>
        ...
        appenTo += `<button type="button"  data-toggle="popover" title="Popover title" data-content="This is a multi selection option to select participants which you have created in users."><i class="fa fa-question-circle"></i></button>
      </div>
   </div>
</li>
`;
        ...
        var appenTo = `
<li id="participant_` + jonee.id + `" data-position='-1'>
   <div class="presenter-outer">
      <div class="con-left">
         <img src="` + jonee.image + `" alt="" >
      </div>
      <div class="con-right">
         <div class="john-title">` + jonee.first_name + `</div>
      ...
      <div class="con-right-right">`;
        if (jonee.id != user.id) {
          ...
          //if (jonee.plan_id == 4) {
          color = '#000000';
          icon = base_url + 'agora/images/raise-b.png';
          //}
          //<a class="presenter" id="make_presenter_` + jonee.id + `" href="javascript:makepresenter(` + jonee.id + `,'true')"><i class="fa fa-television admin-icon" aria-hidden="true"></i></a>
          appenTo += `<a onClick="un_raise_admin(` + jonee.id + `)" data-user="` + jonee.id + `" id="raise_btn_mute_` + jonee.id + `" style="display:none" title="Lower Hand"><img src="` + icon + `" class="hands-raised"></a><a style="display:none;" id="pin_user_raise_` + jonee.id + `" href="javascript:pinUser(` + jonee.id + `)"><i class="fa fa-thumb-tack" aria-hidden="true" style="color:#72b772"></i></a>
         <a class="chat_btn_mute" id="chat_btn_mute_` + jonee.id + `" href="javascript:muteunmuteremote(` + jonee.id + `,'mute','chat')"><i class="fa fa-commenting" aria-hidden="true" style="color:#0080008a"></i></a>
         <a class="chat_btn_unmute" id="chat_btn_unmute_` + jonee.id + `" href="javascript:muteunmuteremote(` + jonee.id + `,'unmute','chat')" style="display:none"><i class="fa fa-commenting" aria-hidden="true"></i></a>
         <a class="mic_btn_mute" id="mic_btn_mute_` + jonee.id + `" href="javascript:muteunmuteremote(` + jonee.id + `,'mute','mic')"><i class="fa fa-microphone-slash" aria-hidden="true" style="color:#0080008a"></i></a>
         <a class="mic_btn_unmute" id="mic_btn_unmute_` + jonee.id + `" href="javascript:muteunmuteremote(` + jonee.id + `,'unmute','mic')" style="display:none"><i class="fa fa-microphone-slash" aria-hidden="true"></i></a>
        ...
        appenTo += `<button type="button"  data-toggle="popover" title="Popover title" data-content="This is a multi selection option to select participants which you have created in users."><i class="fa fa-question-circle"></i></button></div>
   </div>
</li>
`;
          ...
          if (jonee.id == $('#now_presenting').val() && $('#now_presenting').val() != 0) {
            $('#presenter-list')
              .append($(" <option > < /option>")
                  ...
                  .text(jonee.first_name + ':' + jonee.email));
              }
            else {
              $('#presenter-list')
                .append($(" <option > < /option>")
...
<li id="participant_` + jonee.id + `" data-position='-1'>
   <div class="presenter-outer">
      ...
      <div class="con-right-right">`;
         ...
         <a class="mic_btn_mute" id="mic_btn_mute_` + jonee.id + `" href="javascript:muteunmuteremote(` + jonee.id + `,'mute','mic')"><i class="fa fa-microphone-slash" aria-hidden="true" style="color:#0080008a"></i></a>
         <a class="mic_btn_unmute" id="mic_btn_unmute_` + jonee.id + `" href="javascript:muteunmuteremote(` + jonee.id + `,'unmute','mic')" style="display:none"><i class="fa fa-microphone-slash" aria-hidden="true"></i></a>
         <a href="javascript:void(0)" data-toggle="tooltip" title="This is a multi selection option to select participants which you have created in users."><i class="fa fa-question-circle"></i></a>`;
              }
              if (jonee.id != user.id) {
                appenTo += `<a class="video_btn_mute" id="video_btn_mute_` + jonee.id + `" href="javascript:muteunmuteremote(` + jonee.id + `,'mute','video')"><i class="fa fa-video-camera" aria-hidden="true" style="color:#0080008a"></i></a>       
         <a class="video_btn_unmute" id="video_btn_unmute_` + jonee.id + `" href="javascript:muteunmuteremote(` + jonee.id + `,'unmute','video')" style="display:none"><i class="fa fa-video-camera" aria-hidden="true"></i></a>`;
...
`;
          ...
          //console.log('here =======gf 3');

          var appenTo = `<li id="participant_` + jonee.id + `">
                      <div class="participant-outer">
                        
                        <div class="participant-right-div">
                          <h1>` + jonee.first_name + `</h1>
                        </div>`;
          if ($('#my_user_id').val() == $('#now_presenting').val()) {
            appenTo += `
   <div class="con-right-right corner-right-presenter current_user_presenter_` + $('#my_user_id').val() + `">
      `;
          } else {
            appenTo += `
      <div class="con-right-right corner-right-presenter current_user_presenter_` + $('#my_user_id').val() + `" style="display:none">`;
          }
          if (jonee.id != user.id) {
            let color = '';
            let icon = ''
...
function handleEvents(rtc) {
  ...
  rtc.client.on("peer-leave", function (evt) {
    ...
    if (evt.uid == organizer_id) {
      ...
      $("#organizer_status").html(`<span id="organizer_status_offline">Organiser Is offline. <a href="#" style="color:red;">LEAVE</a></span> `);
      //console.log('Fcukk here ');
  ...
  rtc.client.on("stream-subscribed", function (evt) {
    ...
    url += "getUser/" + id + "?conf_id=" + conf_id;
    $.ajax({
      url: url,
      success: function (result) {
        jonee = JSON.parse(result);
        //console.log(jonee,"====joinee name");
        if (jonee.image == '' || jonee.image == null) jonee.image = base_url + `agora/images/client.jpg`;
        else {
  ...
  rtc.client.init(option.appID, function () {
    ...
    rtc.client.join(option.token ? option.token : null, option.channel, option.uid ? +option.uid : null, function (uid) {
      ...
      rtc.localStream.init(function () {
        ...
        // }
/* Mute audio if not organizer or presenter */
if($('#my_user_id').val() != $('#organizer_id').val() && $('#my_user_id').val() != $('#now_presenting').val())
{
   setTimeout(function () {
            $('#mute-audio').click()
          }, 1000);
        ...
        if (err.msg == "NotFoundError") {
          ...
          setTimeout(function () {
            alert('Make sure your camera and mic are working and you give permssions to use those');
             if($('#prefix').val() == '' ){
              window.location = base_url+"session-hall" ;
              }else if( $('#prefix').val() == 'superadmin'  ){
                  window.location = base_url+"superadmin/dashbaord";
              }else{
                  window.location = base_url +$('#prefix').val() + "/dashboard";
              }
          }, 2000);
        }
...
function startrecording(refresh = false) {
  ...
  url += "cloud-recording-acquire?cname=" + cname + "&conference_id=" + conference_id + "&screen_id=" + screen_share_id;
  ...
  $.ajax({
    ...
    success: function (result) {
      ...
      if (!refresh) {
        ...
        if ($('#uid_sharescreen').val() != '') {
          setTimeout(function () {
            updateRecordingLayout($('#share_screen_id').val(), '1');
          }, 1000);
        }
        var msg = JSON.stringify(message);
        RTMClient.activeChennel.sendMessage({
          text: msg
        }).then(() => {
...
function stoprecording() {
  ...
  url += "cloud-recording-stop?video_streaming_id=" + video_streaming_id;
...
function stoprecordingRefresh() {
  ...
  url += "cloud-recording-stop-refresh/" + conference_id;
...
$(function () {
  ...
  getDevices(async function (devices) {
    ...
    if (validator(confernce_params, fields)) {
      ...
      joinscreen();
      joinrtm();
//alert('fcuk here ' + 'org id ' + organizer_id  + ' userid '+  user.id);
  ...
  if (organizer_id != user.id) {
    ...
    if (validator(params, fields)) {
      ...
      //   if (!alert('Conference will be started on ' + time_left)) document.location = '/my-conferences';
      ...
      $.confirm({
        ...
        buttons: {
          confirm: function () {
            endConferenceAll();
            organizerLeft();
            //set end time for all session attendees 
            if($('#prefix').val() == '' ){
              window.location = base_url+"give-rating/"+ $('#conference_id').val();
            }else if( $('#prefix').val() == 'superadmin'  ){
                window.location = base_url+"superadmin/dashboard";
            }else{
                window.location = base_url +$('#prefix').val() + "/dashboard";
            }
  ...
  $("#unmute-audio").on("click", function (e) {
    //alert('unmute-audio ' + mic_muted_by_org);
  ...
  $("#sharescreen").on("click", function (e) {
    e.preventDefault();
   // alert($('#now_presenting').val() + ' organizer_id '+ organizer_id);
...
screenClient.init(confernce_params['appID'], function() {
  screenClient.join(null, confernce_params['channel'], "1"+confernce_params['uid'], function(uid) {
        ...
        //console.log(screenClient.publish(screenStream),"publish screen");
 ...
 RTMClient.activeChennel.sendMessage({ text: msg}).then(() => {
      //console.log(msg+'======startrecording1');
    console.log(msg+'===fghfghfghfghf===ccgfhfghfg');
      $('#uid_sharescreen').val(user_id);
...
screenStream.init(function() {
  ...
  $('#share-screen-id').val(screenStream.getId());
      ...
      $("#organiser-img #local_stream").css('display' ,'block');
...
function pinUserFrame(uid) {
  if (pinned_user == null) {
    $(".watct_img").html($("#remote_video_panel_" + uid));
...
function muteunmuteremote(uid, action, stream) {
  ...
  RTMClient.activeChennel.sendMessage({
    ...
    if (message.type == "mute" && message.stream == "chat" && message.uid == 'all') {
      ...
      if ($('#now_presenting').val() != '0') {
        setTimeout(function () {
          $('#chat_btn_unmute_' + $('#now_presenting').val()).hide();
          $('#chat_btn_mute_' + $('#now_presenting').val()).show();
        }, 100);
      }
    }
...
//** **/
  ...
  RTMClient.activeChennel.sendMessage({
    ...
    assignPresenter(uid);
    muteunmuteremote(uid,'unmute','mic')

  //    $("#organiser-img").html(''); 
  // $("#organiser-img").prepend($("#remote_video_panel_"+uid));
...
function makepresenterLocal(uid, selfclicked = false) {
  ...
  var msg = JSON.stringify(message);
  if (selfclicked) {
   // alert('is_screen_shared ' + is_screen_shared);
    if (!is_screen_shared) {
      RTMClient.activeChennel.sendMessage({
        text: msg
      }).then(() => {
...
function assignPresenter(uid) {
  ...
  if (uid == organizer_id) {
    //alert( 'here '+ is_screen_shared );
    if (is_screen_shared) {
      stopShareScreenRemote();
    }

     //alert( 'now shared screen '+ is_screen_shared );
    if ($("#remote-streams").is(':empty')) {  //alert('empty');
    ...
    prsenterLog(0);
    $("#local_stream_container").prepend($("#local_stream"));
    $('.video-call-center').css('display' , 'block' );
  // alert('sdbfkjsdfkjsd');
    $('.shared_screen_presenter').hide();
  } else {
    ...
    if (final_id == organizer_id) {
      $("#organiser-img").prepend($("#local_stream"));
      $(".organiser-img-outer").hide();
      if ($("#remote-streams").is(':empty')) {  } else {
...
function joinrtm() {
  ...
  RTMClient.login({
    token: null,
    uid: String(confernce_params['uid'])
  }).then(() => {
    RTMClient._logined = true;
    creteRTMChannel();
    $("#send_rtm_channel_message").html("<img src=" + base_url + "agora/images/send.png>");
...
function subscribeRTMChannelMessages() {
  RTMClient.activeChennel.on('ChannelMessage', ({
    text
  }, senderId) => { // text: text of the received channel message; senderId: user ID of the sender.
    ...
    if (message.type == "channelMessage") {
      ...
      //alert('message recieved'+ message.uid);
      ...
      if (message.uid == 'all') {
        ...
        if ($('#now_presenting').val() == $('#mute-audio').data('userid')) {} else if ($('#mute-audio').data('userid') == organizer_id) {} else {
          $('#mute-audio').click();
        }
      } else {
        $('#mute-audio').click();
      ...
      if (message.uid == 'all') {
        //alert(JSON.parse($("#translators_id").val()).includes($('#mute-audio').data('userid')));
        if (JSON.parse($("#translators_id").val()).includes($('#mute-video').data('userid'))) {} else if ($('#now_presenting').val() == $('#mute-video').data('userid')) {} else if ($('#mute-video').data('userid') == organizer_id) {} else {
          $('#mute-video').click();
        }
      } else {
        $('#mute-video').click();
      ...
      //$('#chat_control').hide(); 
      if (message.uid == 'all') {
        if ($('#now_presenting').val() == $('#mute-video').data('userid')) {} else if ($('#mute-video').data('userid') == organizer_id) {} else {
          $('#chat_control').hide();
        }
      } else {
        $('#chat_control').hide();
...
////////////////////////////////////
function endConferenceAll() {
  $.ajax({
    type: "POST",
    url: "/api/end-conference-all",
    data: {
...
function endConferenceTime() {
  $.ajax({
    type: "POST",
    url: "/api/end-conference-time",
    data: {
      "_token": $('meta[name="csrf-token"]').attr('content'),
...
$(document).ready(function () {
  ...
  if ($('#remote-camera').val() == '1' && $('#my_user_id').val() == $('#organizer_id').val()) {
    setTimeout(function () {
      muteunmuteremote('all', 'mute', 'video')
    }, 3000);
  }
  if ($('#remote-chat').val() == '1' && $('#my_user_id').val() == $('#organizer_id').val()) {
    setTimeout(function () {
      muteunmuteremote('all', 'mute', 'chat')
    }, 3000);
  }
